...
# Configuration
# -------------------------------------------------------------------------
$RepoUrl = "https://github.com/mateuszstoch/DRCP"
$InstallDir = "$HOME\.drcp"
...
if ($Version -eq "latest") {
    $DownloadUrl = "$RepoUrl/releases/latest/download/drcp-$Target.zip"
} else {
    $DownloadUrl = "$RepoUrl/releases/download/$Version/drcp-$Target.zip"
}

# -------------------------------------------------------------------------
# Installation Logic
# -------------------------------------------------------------------------
Write-InfoBold "Installing drcp ($Version) for $Target..."
...
$ZipPath = "$BinDir\drcp_download.zip"
...
# -------------------------------------------------------------------------
Write-Host ""
Write-Success "drcp ($Version) was installed successfully to $ExePath"
Write-Host ""
